...
/**
 * Production self-heal: footer CMS tables may be missing if migration history was
 * bootstrapped/repaired without running 20260807120000-create-footer-menus-pages.
 * Idempotent — safe on local DBs that already have the tables.
 */
module.exports = {
  ...
  async down() {
    // Do not drop — production may already have CMS data.
  }
};
