...
/**
 * Enable XXPay provider rows for remaining allowlisted stores:
 * casinoslots, goodwork, winners4.
 * (betgamezone + grandsweeps are intentionally not allowlisted.)
 *
...
module.exports = {
  async up(queryInterface, Sequelize, opts = {}) {
    ...
    const stores = ['casinoslots', 'goodwork', 'winners4'];
  ...
  async down(queryInterface, Sequelize, opts = {}) {
    ...
    await queryInterface.sequelize.query(
      ...
      SET
        ...
        updated_at = NOW()
      WHERE provider_code = 'xxpay'
        AND LOWER(store_code) IN ('casinoslots', 'goodwork', 'winners4')
      `,
      { transaction }
    );
  }
